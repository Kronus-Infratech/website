...
export default function SellerLoginPage() {
    const { login, user, loading: authLoading } = useSellerAuth();
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        try {
            ...
            if (
                ...
                const signupUrl = `/seller/signup?email=${encodeURIComponent(email)}&prefill=true&noAccount=true`;
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gray-950 relative flex-col items-center justify-center p-12">
                ...
                <div className="relative z-10 max-w-md text-center">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                        List your properties, manage listings, and reach thousands
                        of potential buyers on our platform.
                    </p>
                    <div className="mt-10 grid grid-cols-3 gap-6 text-center">
                        <div>
                            ...
                            <div className="text-xs text-gray-500 mt-1">Sellers</div>
                        </div>
                        <div>
                            <div className="text-2xl font-bold text-teal font-heading">
                                500+
                ...
                <div className="w-full max-w-sm">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-8">
                        ...
                        <div className="flex items-center">
                            <Link
                                href="/seller/signup"
                                className="w-full text-center py-2.5 border-2 bg-teal text-white rounded-lg font-semibold hover:bg-teal/90 transition"
                            >
                                Start Selling
                            </Link>
                        </div>
